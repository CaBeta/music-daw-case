...
- 本轮重点：优先修复失败热点步骤：unit

## 4) Proposed Work Items

- [ ] W1: 生成并执行任务包（见 harness/task-packs/task-pack-2026-04-02.md）
- [ ] W2: 提升 e2e 覆盖（含异常路径）
...
- [ ] AC3: 运行 pnpm run harness:eval -- --task auto-next-2026-04-02 输出 PASS
